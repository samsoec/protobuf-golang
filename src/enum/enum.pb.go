...
const (
	DayName_UNKNOWN   DayName = 0
	DayName_SUNDAY    DayName = 1
	DayName_MONDAY    DayName = 2
	DayName_TUESDAY   DayName = 3
	DayName_WEDNESDAY DayName = 4
	DayName_THURSDAY  DayName = 5
	DayName_FRIDAY    DayName = 6
	DayName_SATURDAY  DayName = 7
)

// Enum value maps for DayName.
var (
	DayName_name = map[int32]string{
		0: "UNKNOWN",
		1: "SUNDAY",
		2: "MONDAY",
		3: "TUESDAY",
	...
	DayName_value = map[string]int32{
		"UNKNOWN":   0,
		"SUNDAY":    1,
		"MONDAY":    2,
		"TUESDAY":   3,
...
func (DayName) Descriptor() protoreflect.EnumDescriptor {
	return file_enum_enum_proto_enumTypes[0].Descriptor()
}

func (DayName) Type() protoreflect.EnumType {
	return &file_enum_enum_proto_enumTypes[0]
}

func (x DayName) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use DayName.Descriptor instead.
...
type EnumMessage struct {
	...
	DayName DayName `protobuf:"varint,2,opt,name=day_name,json=dayName,proto3,enum=example.enumeration.DayName" json:"day_name,omitempty"`
}
...
func (x *EnumMessage) GetDayName() DayName {
	if x != nil {
		return x.DayName
	}
	return DayName_UNKNOWN
}
...
var file_enum_enum_proto_rawDesc = []byte{
	...
	,
...
var file_enum_enum_proto_goTypes = []interface{}{
	(DayName)(0),        // 0: example.enumeration.DayName
	(*EnumMessage)(nil), // 1: example.enumeration.EnumMessage
}
var file_enum_enum_proto_depIdxs = []int32{
	0, // 0: example.enumeration.EnumMessage.day_name:type_name -> example.enumeration.DayName
